...
IUSE="cups gnome gnome-keyring hidpi kerberos neon pic +proprietary-codecs pulseaudio selinux +tcmalloc vaapi nacl"
...
src_prepare() {
	...
	if use vaapi; then
		#epatch -p1 "${FILESDIR}/no_hardcode_va_driver_path.patch"
		epatch -p1 "${FILESDIR}/enable_vaapi_on_linux_44.0.2403.18.patch"
	fi
