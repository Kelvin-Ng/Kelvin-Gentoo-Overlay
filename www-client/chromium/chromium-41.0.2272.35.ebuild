...
IUSE="bindist cups gnome gnome-keyring hidpi kerberos neon pic pulseaudio selinux +tcmalloc vaapi"
...
src_prepare() {
	...
	if use vaapi; then
		epatch -p1 "${FILESDIR}/enable_vaapi_on_linux_41.0.2272.16.patch"
	fi
