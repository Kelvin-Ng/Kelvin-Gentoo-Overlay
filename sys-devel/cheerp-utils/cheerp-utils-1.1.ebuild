...
#src_compile() {
#	cd "${S}"
#	emake -C include INSTALL_PREFIX="${D}/opt/cheerp"
#}

src_install() {
	cd "${S}"
	emake -C include install INSTALL_PREFIX="${D}/opt/cheerp"
	emake -C tools install INSTALL_PREFIX="${D}/opt/cheerp"
	emake -C tests install INSTALL_PREFIX="${D}/opt/cheerp"
}
