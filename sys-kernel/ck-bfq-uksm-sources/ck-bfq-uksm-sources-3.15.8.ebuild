...
CK_VERSION="1"
BFS_VERSION="449"
UKSM_MAJOR_VERSION="0.1.2.3"
UKSM_VERSION="${UKSM_MAJOR_VERSION}-for-v3.15.ge.3"
...
BFS_BASE_URL="http://ck.kolivas.org/patches/bfs/3.0"
BFS_LVER_URL="${BFS_BASE_URL}/${K_BRANCH_ID}"
BFS_URI="${BFS_LVER_URL}/${BFS_FILE}"
UKSM_URI="http://kerneldedup.org/download/uksm/${UKSM_MAJOR_VERSION}/${UKSM_FILE}"
